...
//#region node_modules/.nitro/vite/services/ssr/assets/router-CrD1GWXM.js
var router_CrD1GWXM_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-eJ_hHy_B.css";
var APP_NAME = "港股模擬盤";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "港股紙上交易模擬：恒生指數、買賣差價、本金港幣一萬，挑戰一億財富自由。"
			}
		],
		links: [
			{
...
var $$splitComponentImporter = () => import("./routes-Cmqfdtdg.mjs");
...
//#endregion
export { getRouter, router_CrD1GWXM_exports as t };
