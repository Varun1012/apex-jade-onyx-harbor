...
export const NEWS_POOL: { text: string; bias: number; focus?: string }[] = [
  ...
  { text: "商湯大模型訂單增加，AI 股受捧", bias: 0.5, focus: "0020" },
  { text: "商湯仍未轉盈，市場憂慮燒錢速度", bias: -0.4, focus: "0020" },
  { text: "中芯國際產能利用率回升，半導體股急彈", bias: 0.55, focus: "0981" },
  { text: "出口管制傳聞再起，中芯國際遭拋售", bias: -0.5, focus: "0981" },
  { text: "覆銅板報價上調，建滔積層板獲資金追捧", bias: 0.55, focus: "1888" },
  { text: "覆銅板報價回落，建滔積層板高位回吐", bias: -0.45, focus: "1888" },
  { text: "智譜大模型訂閱勝預期，AI 股交投爆量", bias: 0.6, focus: "2513" },
  { text: "智譜估值偏高，獲利盤湧現", bias: -0.5, focus: "2513" },
